...
export default function HomeScreen() {
  ...
  return (
    ...
    >
      <Text
        style={[styles.headerText, { alignSelf: "flex-start", fontSize: 24 }]}
      >
        {" "}
        Welcome! {user ? `${user.email}` : "Not Loogged in... how...?"}
      </Text>
      ...
      >
        <Image
          ...
          source={require("../images/home/project_icon.png")}
        />
        <Text style={[styles.btnText, { left: -25, textAlign: "center" }]}>
          Projects
        </Text>
      </Pressable>
      ...
      >
        <Image
          ...
          source={require("../images/home/images_icon.png")}
        />
        <Text style={[styles.btnText, { left: -28, textAlign: "center" }]}>
          Images
        </Text>
      </Pressable>
      ...
      <View>
        <Text
          style={[styles.headerText, { fontSize: 20, alignSelf: "flex-start" }]}
        >
          Jump back in!
        </Text>
        <View
      ...
      <Pressable
        style={[styles.homeButton, { margin: 5 }]}
        data={recentProj}
        onPress={() =>
          navigation.navigate("selectedProject", { projectID: recentProj?.id })
        }
      >
        <View style={{ flexDirection: "column", alignItems: "center" }}>
          ...
          >
            {recentProj?.name || "No Project Loaded, get grinding!"}
          </Text>
          <Text
            style={[styles.btnText, { fontSize: 14, textTransform: "none" }]}
          >
            Time: {recentProj?.totalMinutes || "Not specified"} minutes
          </Text>
        </View>
      </Pressable>
      ...
      <View
        style={[
          styles.cloud,
          { zIndex: -1, top: -100, right: -20, backgroundColor: "#B6BCFB" },
        ]}
      ></View>
